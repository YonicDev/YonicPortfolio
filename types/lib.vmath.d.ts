declare module "vmath" {
   ...
   /**
    ...
    class vec2 {
         ...
         * @function
         */
        static forEach (a: vec2[], stride: number, offset: number, count: number, fn:Function, arg?): vec2[];
    ...
    class vec4 {
         ...
         * @function
         */
        static forEach(a: vec4[], stride: number, offset: number, count: number, fn: Function, arg?): vec4[];
    ...
    */
    class quat {
         ...
         * @returns out
         */
        static rotateAround(out: quat, rot: quat, axis: vec3, rad: number)
         ...
         * @returns out
         */
        static sqlerp(out: quat, a: quat, b: quat, c: quat, d: quat, d: quat, t: number): quat;
